/// Backend module Luau runtime.
///
/// Backend modules run inside a real Luau VM via `mlua`. The shell host only
/// injects generic host APIs; all service-specific logic remains in module
/// scripts.
...
fn log_message(module_id: &str, level: &str, message: &str) {
