...
/// mesh.locale.format_number(value) → string   (requires locale.read)
/// mesh.locale.format_date(timestamp, style?)  (requires locale.read)
/// mesh.locale.format_duration(seconds)        (requires locale.read)
