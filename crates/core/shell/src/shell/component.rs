...
use mesh_core_elements::{
    Corners, ElementState, LayoutEngine, StyleContext, StyleResolver, TransitionEasing,
    TransitionStyle, VariableStore, WidgetNode, element_snapshot_json, style::Color,
};
...
impl FrontendSurfaceComponent {
    ...
    fn build_tree(&mut self, theme: &Theme, width: u32, height: u32) -> WidgetNode {
        ...
        LayoutEngine::compute_with_measurer(&mut tree, width as f32, height as f32, Some(&measurer));
...
impl FrontendSurfaceComponent {
    ...
    fn prune_stale_interaction_targets(&mut self, tree: &WidgetNode) {
...
fn collect_all_keys(node: &WidgetNode, keys: &mut std::collections::HashSet<String>) {
...
"#,
        ...
        assert_eq!(runtime_instances_after_first, 1, "should have exactly 1 runtime after first paint");
