...
fn profiling_invalidation_json(
    ...
    serde_json::json!({
        ...
        "paint": {
            ...
            "subtree_segments_reused": snapshot.paint.subtree_segments_reused,
            "subtree_segments_rebuilt": snapshot.paint.subtree_segments_rebuilt,
            "subtree_commands_rebuilt": snapshot.paint.subtree_commands_rebuilt,
            "full_fallback_count": snapshot.paint.full_fallback_count,
            "broad_dirty_fallback_count": snapshot.paint.broad_dirty_fallback_count,
            ...
            "filtered_span_count": snapshot.paint.filtered_span_count,
            ...
            "filtered_fallback_count": snapshot.paint.filtered_fallback_count,
