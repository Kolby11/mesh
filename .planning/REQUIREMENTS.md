...
- [ ] **STYLE-01**: Maintainer has a documented bounded style profile for MESH's XML/.mesh, CSS-like syntax, and theme tokens, covering supported visual properties and explicitly excluding arbitrary browser CSS.
