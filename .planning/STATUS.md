...
is S01-DEAD-010: either connect `Lifecycle`, `Configuration`, and `Resource`
diagnostic categories to their real producers or document them as reserved
wire values before considering removal.
