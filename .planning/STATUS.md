...
The next open item is completing frontend runtime lifecycle and recovery:
dispatching mount/unmount, making prop publication transactional, and
preserving truthful typed, source-located diagnostics on failures.
