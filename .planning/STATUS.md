...
The next open item is unifying visibility, transformed geometry, disabled/inert
eligibility, and target filtering across interaction, rendering, focus,
scrolling, tooltips, and accessibility.
