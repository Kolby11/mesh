...
The next open item is unifying template expression semantics and root-scope
validation around the real Luau parser/runtime, then enforcing imported
public-prop and child-surface contracts.
