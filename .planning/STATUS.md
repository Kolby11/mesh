...
The next open item is S01-LOGIC-006: bounding diagnostic issue count,
code/message bytes, health summaries, and debug payload growth per module
instance with an explicit overflow diagnostic.
