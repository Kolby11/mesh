...
| 41-02-01 | 02 | 2 | PROOF-01 | T-41-02-01 | Shell runtime consumes graph provider records and does not infer service powers from provider identity | unit | `nix develop -c cargo test -p mesh-core-shell installed_module_graph` | yes | pending |
