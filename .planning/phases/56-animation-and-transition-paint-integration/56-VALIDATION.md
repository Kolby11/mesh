...
| 56-02-01 | 02 | 2 | ANIM-02 | T-56-03 | Paint-only transitions avoid full layout | unit | `nix develop -c cargo test -p mesh-core-shell animation_transition_dirty -- --nocapture` | ✅ | ✅ green |
