...
|---|-------|------|--------------|------------------|
| 60 | Surface Keybind Dispatch Runtime | Route manifest-owned actions through focused-surface component input without breaking existing keyboard precedence | KDISP-01, KDISP-02, KDISP-03, KDISP-04 | 4 |
