...
**Active milestone: v1.17 Performance: Scripting VM Consolidation** — Phase 92 in progress.

## Phases

- [ ] **Phase 92: VM Pool Foundation** — New `LuaVmPool`, `PooledVm` RAII types, and `ChunkCache`; no behavioral change to existing `ScriptContext`.
