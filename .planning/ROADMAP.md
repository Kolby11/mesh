...
|---|-------|------|--------------|------------------|
| 51 | Painter Contract And Backend Boundary | Define the backend-neutral painter command API and document backend obligations before broad refactor work. | PAINT-01, PAINT-02, BACKEND-01, BACKEND-02 | 4 |
