...
local devices = require("@mesh/network@>=1.0").devices()

-- Connect to a Bluetooth device
local result = require("@mesh/network@>=1.0").connect("AA:BB:CC:DD:EE:FF")
if result.ok then
    -- success
else
...
local result = require("@mesh/network@>=1.0").disconnect("AA:BB:CC:DD:EE:FF")
```
