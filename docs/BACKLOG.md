...
- [ ] Complete IME/text-input-v3 support by rendering preedit state and covering live compositor/lifecycle behavior; the per-seat objects, atomic `done` transactions, deletion, and surrounding-text publication are now wired.
